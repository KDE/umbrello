 ...
 */
CategoryWidget::CategoryWidget(UMLCategory *o) : UMLRectWidget(o)
{
...
/// Reimplemented from UMLRectWidget::paint to draw this widget.
...
/// Reimplemented from UMLRectWidget::saveToXMI to save CategoyWidget
void CategoryWidget::saveToXMI( QDomDocument & qDoc, QDomElement & qElement )
{
    ...
    UMLRectWidget::saveToXMI( qDoc, categoryElement );
