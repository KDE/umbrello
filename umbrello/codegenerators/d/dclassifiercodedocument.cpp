...
{
    setFileExtension(QStringLiteral(".d"));
    ...
    while (!telement.isNull()) {
        ...
        if (nodeName == QStringLiteral("textblocks")) {
            ...
            while (!element.isNull()) {
                ...
                } else if (name == QStringLiteral("dclassdeclarationblock")) {
...
void DClassifierCodeDocument::updateContent()
{
    ...
    QString packageText = getPackage().isEmpty() ? QString() : QString(QStringLiteral("package ")+pkgs+QLatin1Char(';')+endLine);
    ...
    if (hasObjectVectorClassFields())
        importStatement.append(QStringLiteral("import d.util.*;"));
    ...
    QString emptyConstStatement = QStringLiteral("public ")+DClassName+QStringLiteral(" () { }");
