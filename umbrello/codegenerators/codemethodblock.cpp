...
void CodeMethodBlock::setAttributesOnNode(QDomDocument & doc, QDomElement & elem)
{
    ...
    if (contentType() != AutoGenerated)
    {
        ...
        elem.setAttribute(QLatin1String("startMethodText"), encodeText(getStartMethodText(), endLine));
        elem.setAttribute(QLatin1String("endMethodText"), encodeText(getEndMethodText(), endLine));
    }
}
