...
// #include "cppclassdeclarationblock.h"

// Constructors/Destructors
//  

CPPClassifierCodeDocument::CPPClassifierCodeDocument ( UMLClassifier * concept , CPPCodeGenerator *parent) 
   : ClassifierCodeDocument (concept, (CodeGenerator *) parent) { 
	init();
};

CPPClassifierCodeDocument::~CPPClassifierCodeDocument ( ) { };
 ...
 */
/*
CodeDocumentDialog CPPClassifierCodeDocument::getDialog ( ) {

}
*/

bool CPPClassifierCodeDocument::forceDoc () {
        return getParentGenerator()->forceDoc();
}

// We overwritten by CPP language implementation to get lowercase path
/*
QString CPPClassifierCodeDocument::getPath ( )
{
...
QString CPPClassifierCodeDocument::getCPPClassName (QString name) {
...
/*
CPPClassDeclarationBlock * CPPClassifierCodeDocument::getClassDecl ( )
{

        // So we see if it already exists, IF it *does* then we wont create a 
	// new one.
        CPPClassDeclarationBlock * codeBlock = (CPPClassDeclarationBlock *) findTextBlockByTag("classBlock");
	if(!codeBlock) {
		codeBlock = new CPPClassDeclarationBlock (this);
...
void CPPClassifierCodeDocument::declareClassFields (QPtrList<CodeClassField> & list ,
 ...
 */
bool CPPClassifierCodeDocument::saveToXMI ( QDomDocument & doc, QDomElement & root ) {
        bool status = true;
 ...
 */
void CPPClassifierCodeDocument::loadFromXMI ( QDomElement & root ) {
 ...
 * in the XMI document.
 */
void CPPClassifierCodeDocument::setAttributesOnNode ( QDomDocument & doc, QDomElement & docElement)
{
 ...
 */
void CPPClassifierCodeDocument::setAttributesFromNode ( QDomElement & root)
{
...
void CPPClassifierCodeDocument::init ( ) {
...
// of the document
bool CPPClassifierCodeDocument::addCodeOperation (CodeOperation * op ) {
 ...
 */
CodeAccessorMethod * CPPClassifierCodeDocument::newCodeAccessorMethod( CodeClassField *cf, CodeAccessorMethod::AccessorType type ) {
 ...
 */
CodeOperation * CPPClassifierCodeDocument::newCodeOperation( UMLOperation * op) {
        return getParentGenerator()->newCodeOperation(this, op);
}

QString CPPClassifierCodeDocument::scopeToCPPDecl(Uml::Scope scope)
{
        QString scopeString;
        switch(scope)
        {
...
void CPPClassifierCodeDocument::updateContent( ) 
{
...
/*
	...
	// get the declaration block. If its not already present, add it too
        CPPClassDeclarationBlock * classDeclBlock = getClassDecl ( );
