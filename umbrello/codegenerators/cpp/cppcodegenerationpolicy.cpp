...
void CPPCodeGenerationPolicy::init()
{
    ...
    m_vectorMethodAppendBase = QStringLiteral(DEFAULT_VECTOR_METHOD_APPEND);
    m_vectorMethodRemoveBase = QStringLiteral(DEFAULT_VECTOR_METHOD_REMOVE);
    m_vectorMethodInitBase = QStringLiteral(DEFAULT_VECTOR_METHOD_INIT);
    m_objectMethodInitBase = QStringLiteral(DEFAULT_OBJECT_METHOD_INIT);
