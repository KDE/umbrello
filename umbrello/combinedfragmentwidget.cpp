...
/**
 * Reimplemented from UMLRectWidget::paint to draw
 ...
 */
void CombinedFragmentWidget::askNameForWidgetType(UMLRectWidget* &targetWidget,
...
/**
 * Reimplemented from UMLRectWidget::saveToXMI to save widget data
...
void CombinedFragmentWidget::saveToXMI( QDomDocument & qDoc, QDomElement & qElement )
{
    ...
    UMLRectWidget::saveToXMI( qDoc, combinedFragmentElement );
