...
void ListPopupMenu::insertStdItems(bool insertLeadingSeparator /* = true */,
                                   Uml::Widget_Type type /* = wt_UMLRectWidget */)
{
 ...
 *
 * @return The owned UMLWidget if this menu is owned by a
 *         widget. Otherwise returns 0.
 */
UMLWidget* ListPopupMenu::ownerWidget() const
{
