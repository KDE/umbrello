...
ToolBarState* ToolBarStateFactory::getState(const WorkToolBar::ToolBar_Buttons &toolbarButton)
{
    ...
    if (states[key] == NULL)
    {
        ...
        case 0:
            states[0] = new ToolBarStateOther(m_pUMLView); break;
        case 1:
            states[1] = new ToolBarStateAssociation(m_pUMLView); break;
        case 2:
            states[2] = new ToolBarStateMessages(m_pUMLView); break;

            // This case has no pool.
        case 3:
            states[3] = new ToolBarStateArrow(m_pUMLView); break;
        case 4:
            states[4] = new ToolBarStateOneWidget(m_pUMLView); break;
        }
    }
...
int ToolBarStateFactory::getKey(const WorkToolBar::ToolBar_Buttons &toolbarButton) const
{
    ...
    case WorkToolBar::tbb_Activity_Transition:
        return 1;
    case WorkToolBar::tbb_Exception:
        return 1;
    ...
    case WorkToolBar::tbb_Seq_Message_Asynchronous:
        return 2;
    case WorkToolBar::tbb_Seq_Message_Found:
        return 2;
    case WorkToolBar::tbb_Seq_Message_Lost:
        return 2;

    case WorkToolBar::tbb_Seq_Precondition:
        return 4;
    case WorkToolBar::tbb_Seq_End_Of_Life:
        return 4;
    case WorkToolBar::tbb_Pin:
        return 4;

        // Arrow pointer
    case WorkToolBar::tbb_Arrow:
        return 3;
