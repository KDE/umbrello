 ...
 *	The @ref UMLDoc class creates instances of this type.  All Packages will need a unique
...
public:
	 ...
	 */
 	...
 	/**
 	 *	Determine if this package has this association.
	...
	/**
	 *	Returns the number of associations for the Package.
	...
	int associations();
 	...
 	/**
	 *	Return the list of associations for the Package.
	 *
	 *	@return The list of associations for the Package.
	 */
	...
	/**
	 * Creates the UML:Package element including it's operations,
	 * attributes and templates
	 */
	bool saveToXMI( QDomDocument & qDoc, QDomElement & qElement );

	/**
	 * Loads the UML:Package element including it's operations,
	 * attributes and templates
	 */
