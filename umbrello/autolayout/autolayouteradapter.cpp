...
Autolayout::Graph  * Autolayout::AutolayouterAdapter::setGraph( UMLView * _view )
{
    if (! view||view==_view) view=_view; else return 0;
...
void Autolayout::AutolayouterAdapter::updateView( )
{
    UMLWidgetList list = view->getWidgetList();
    UMLWidget* widget;
    Graph *g=getGraph();
