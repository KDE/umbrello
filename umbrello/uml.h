...
#define logDebug0(s) if (Tracer::instance()->isEnabled(DBG_SRC)) \
...
#define logDebug1(s, a) if (Tracer::instance()->isEnabled(DBG_SRC)) \
...
#define logDebug2(s, a, b) if (Tracer::instance()->isEnabled(DBG_SRC)) \
...
#define logDebug3(s, a, b, c) if (Tracer::instance()->isEnabled(DBG_SRC)) \
...
#define logDebug4(s, a, b, c, d) if (Tracer::instance()->isEnabled(DBG_SRC)) \
