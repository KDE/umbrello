...
{
    //kDebug(9007) << "TreeParser::parseTranslationUnit()" << endl;
...
{
    //kDebug(9007) << "TreeParser::parseDeclaration()" << endl;
...
{
    //kDebug(9007) << "TreeParser::parseLinkageSpecification()" << endl;
    if ( ast->linkageBody() )
...
{
    //kDebug(9007) << "TreeParser::parseNamespace()" << endl;
    if ( decl->linkageBody() )
...
{
    //kDebug(9007) << "TreeParser::parseNamespaceAlias()" << endl;
    Q_UNUSED( decl );
}

void TreeParser::parseUsing( UsingAST* decl )
{
    //kDebug(9007) << "TreeParser::parseUsing()" << endl;
    Q_UNUSED( decl );
}

void TreeParser::parseUsingDirective( UsingDirectiveAST* decl )
{
    //kDebug(9007) << "TreeParser::parseUsingDirective()" << endl;
    Q_UNUSED( decl );
}

void TreeParser::parseTypedef( TypedefAST* decl )
{
    //kDebug(9007) << "TreeParser::parseTypedef()" << endl;
    if ( decl->typeSpec() )
...
{
    //kDebug(9007) << "TreeParser::parseTemplateDeclaration()" << endl;
    Q_UNUSED( decl );
}

void TreeParser::parseSimpleDeclaration( SimpleDeclarationAST* decl )
{
    //kDebug(9007) << "TreeParser::parseSimpleDeclaration()" << endl;
    Q_UNUSED( decl );
}

void TreeParser::parseFunctionDefinition( FunctionDefinitionAST* def )
{
    //kDebug(9007) << "TreeParser::parseFunctionDefinition()" << endl;
    Q_UNUSED( def );
}

void TreeParser::parseLinkageBody( LinkageBodyAST* linkageBody )
{
    //kDebug(9007) << "TreeParser::parseLinkageBody()" << endl;
...
{
    //kDebug(9007) << "TreeParser::parseTypeSpecifier()" << endl;
...
{
    //kDebug(9007) << "TreeParser::parseClassSpecifier()" << endl;
...
{
    //kDebug(9007) << "TreeParser::parseEnumSpecifier()" << endl;
    Q_UNUSED( enumSpec );
}

void TreeParser::parseElaboratedTypeSpecifier( ElaboratedTypeSpecifierAST* typeSpec )
{
    //kDebug(9007) << "TreeParser::parseElaboratedTypeSpecifier()" << endl;
    Q_UNUSED( typeSpec );
}

void TreeParser::parseAccessDeclaration ( AccessDeclarationAST * access )
{
    //kDebug(9007) << "TreeParser::parseAccessDeclaration()" << endl;
    Q_UNUSED( access );
}
