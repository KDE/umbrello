...
//    UMLClassifierList getCompositionChildClassifierList();
    ...
    Q_SIGNAL void operationAdded(UMLClassifierListItem *);
    Q_SIGNAL void operationRemoved(UMLClassifierListItem *);

    Q_SIGNAL void templateAdded(UMLClassifierListItem*);
    Q_SIGNAL void templateRemoved(UMLClassifierListItem*);

    // only applies when (m_Type == ot_Class)
    Q_SIGNAL void attributeAdded(UMLClassifierListItem*);
    Q_SIGNAL void attributeRemoved(UMLClassifierListItem*);
