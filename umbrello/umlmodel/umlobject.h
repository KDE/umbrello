    ...
    public:
        ...
        void setQualifiers(Uml::TypeQualifiers::Enum qualifier);
        void setQualifiersCmd(Uml::TypeQualifiers::Enum qualifier);
    ...
    protected:
        ...
        Uml::TypeQualifiers::Enum m_qualifier; ///< object qualifier
