...
/* 
 *  Constructs a ClassAttributesBase as a child of 'parent', with the 
 *  name 'name' and widget flags set to 'f'.
 */
ClassAttributesBase::ClassAttributesBase( QWidget* parent, const char* name, WFlags fl )
    : DialogPage( parent, name, fl ),
      image0( (const char **) image0_data ),
      image1( (const char **) image1_data )
{
    if ( !name )
	setName( "ClassAttributesBase" );
    ClassAttributesBaseLayout = new QVBoxLayout( this, 11, 6, "ClassAttributesBaseLayout"); 
    ...
    m_attributesList = new QListView( groupBox7, "m_attributesList" );
    m_attributesList->addColumn( QString::null );
    m_attributesList->addColumn( tr( "Name" ) );
    m_attributesList->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)7, (QSizePolicy::SizeType)5, 0, 0, m_attributesList->sizePolicy().hasHeightForWidth() ) );

    layout14->addMultiCellWidget( m_attributesList, 0, 1, 0, 0 );
    ...
    layout4->addWidget( m_newButton );

    m_propertiesButton = new QPushButton( groupBox7, "m_propertiesButton" );
    layout4->addWidget( m_propertiesButton );

    m_deleteButton = new QPushButton( groupBox7, "m_deleteButton" );
    layout4->addWidget( m_deleteButton );
    QSpacerItem* spacer_2 = new QSpacerItem( 81, 21, QSizePolicy::Expanding, QSizePolicy::Minimum );
    layout4->addItem( spacer_2 );
    groupBox7Layout->addLayout( layout4 );
    ClassAttributesBaseLayout->addWidget( groupBox7 );
    ...
    ClassAttributesBaseLayout->addWidget( groupBox6 );
    languageChange();
    resize( QSize(483, 381).expandedTo(minimumSizeHint()) );

    // signals and slots connections
    connect( m_attributesList, SIGNAL( selectionChanged(QListViewItem*) ), this, SLOT( itemSelected(QListViewItem*) ) );
    connect( m_newButton, SIGNAL( clicked() ), this, SLOT( createAttribute() ) );
 ...
 */
ClassAttributesBase::~ClassAttributesBase()
{
 ...
 *  language.
 */
void ClassAttributesBase::languageChange()
{
    setCaption( tr( "Class attributes" ) );
    groupBox7->setTitle( tr( "Attributes" ) );
    m_attributesList->header()->setLabel( 0, QString::null );
    m_attributesList->header()->setLabel( 1, tr( "Name" ) );
...
void ClassAttributesBase::itemSelected(QListViewItem*)
{
    qWarning( "ClassAttributesBase::itemSelected(QListViewItem*): Not implemented yet" );
}

void ClassAttributesBase::createAttribute()
{
    qWarning( "ClassAttributesBase::createAttribute(): Not implemented yet" );
}

void ClassAttributesBase::editSelected()
{
    qWarning( "ClassAttributesBase::editSelected(): Not implemented yet" );
}

void ClassAttributesBase::deleteSelected()
{
    qWarning( "ClassAttributesBase::deleteSelected(): Not implemented yet" );
}

void ClassAttributesBase::moveUp()
{
    qWarning( "ClassAttributesBase::moveUp(): Not implemented yet" );
}

void ClassAttributesBase::moveDown()
{
    qWarning( "ClassAttributesBase::moveDown(): Not implemented yet" );
}
